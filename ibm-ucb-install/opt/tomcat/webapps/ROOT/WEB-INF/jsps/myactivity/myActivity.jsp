...
<c:url var="formUrl" value="${MyActivityTasks.viewMyActivity}"/>
<c:url var="myActivityRestUrl" value="/rest2/myactivity?pageIndex="/>
...
<c:import url="/WEB-INF/jsps/home/header.jsp">
   ...
   <c:param name="refreshDisabled" value="true" />
</c:import>
