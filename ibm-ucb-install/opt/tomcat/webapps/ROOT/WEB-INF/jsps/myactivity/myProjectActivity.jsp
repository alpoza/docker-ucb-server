...
<c:url var="formUrl" value="${MyActivityTasks.viewMyProjectActivity}"/>
<c:set var="projectId" value="${fn:escapeXml(project.id)}"/>
<c:url var="myActivityRestUrl" value="/rest2/myactivity/project/${projectId}?pageIndex="/>
...
<c:import url="/WEB-INF/jsps/home/project/header.jsp">
    ...
    <c:param name="noRefresh" value="true" />
</c:import>
