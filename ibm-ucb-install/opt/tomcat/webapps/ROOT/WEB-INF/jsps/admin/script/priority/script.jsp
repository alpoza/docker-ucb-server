...
<ah3:useTasks class="com.urbancode.ubuild.web.admin.script.priority.WorkflowPriorityScriptTasks" />
...
<c:url var="saveUrl"   value="${WorkflowPriorityScriptTasks.saveScript}"/>
<c:url var="cancelUrl" value="${WorkflowPriorityScriptTasks.cancelScript}"/>
...
<form id="scriptForm" method="post" action="${fn:escapeXml(saveUrl)}">
    <table class="property-table">
        <tbody>
            ...
            <error:field-error field="language" cssClass="${eo.next}"/>
            <tr class="${fn:escapeXml(eo.last)}" valign="top">
                <td align="left" width="15%"><span class="bold">${ub:i18n("Language")} <span class="required-text">*</span></span></td>
                <td align="left" colspan="2">
                    <ucf:stringSelector 
                    name="language"  
                    list='<%= ScriptEvaluator.getSupportedLanguages() %>'
            ...
            <tr class="${fn:escapeXml(eo.last)}" valign="top">
                ...
                <td align="left" colspan="2">
                    <span class="inlinehelp">
                      ${ub:i18n("WorkflowPriorityScriptDesc")}
                    </span><br/><br/>
