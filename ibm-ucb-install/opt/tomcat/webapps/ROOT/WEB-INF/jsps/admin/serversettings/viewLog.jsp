...
<c:url var="exportUrl" value="${ServerSettingsTasks.exportServerLog}"/>
...
<div style="padding-bottom: 1em;">
    ...
    <c:param name="selected" value="log"/>
    ...
    <div class="contents">
        ...
        <script type="text/javascript">
            function showLogPage(page) {
                var request = '<%=new ServerSettingsTasks().methodUrl("viewLog", false)%>';
                request = request + "?page=" + page;
                goTo(request);
            }
        </script>
        <ucui:carousel id="pagination" methodName="showLogPage" currentPage="${page}" numberOfPages="${numPages}" numberShown="10" />
