...
<c:url var="saveUrl" value="${WorkflowTemplateTasks.saveCopiedWorkflowTemplate}"/>
<c:url var="cancelUrl" value="${WorkflowTemplateTasks.cancelCopyWorkflowTemplate}"/>
...
<form method="post" action="${fn:escapeXml(saveUrl)}">
  <div>
    <div class="popup_header">
      <ul>
        <li class="current"><a>${workflowTemplate.originating ?
                ub:i18n("CopyBuildProcessTemplate") : ub:i18n("CopySecondaryProcessTemplate")} </a></li>
      </ul>
    </div>
    <div class="contents">
      ...
      <table class="property-table">
        <tbody>
          ...
          <c:set var="name" value="${ub:i18nMessage('CopyNoun', workflowTemplate.name)}"/>
