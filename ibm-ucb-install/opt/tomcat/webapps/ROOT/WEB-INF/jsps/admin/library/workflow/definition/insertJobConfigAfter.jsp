...
<c:url var="insertJobConfigAfterUrl" value="${WorkflowDefinitionTasks.insertJobConfigAfter}"/>

<%-- CONTENT --%>

<form method="post" action="${fn:escapeXml(insertJobConfigAfterUrl)}">
    <div class="system-helpbox">${ub:i18n("LibraryWorkflowInsertJobAfterSystemHelpBox")}</div><br />
    ...
    <table class="property-table">
        <tbody>
            <tr class="${eo.last}" valign="top">
                <td align="left" width="20%"><span class="bold">${ub:i18n("LibraryWorkflowInsertJobAfterWithColon")}</span></td>
    ...
    <br/>
    <ucf:button name="addJob" label="${ub:i18n('LibraryWorkflowAddJob')}"/>
