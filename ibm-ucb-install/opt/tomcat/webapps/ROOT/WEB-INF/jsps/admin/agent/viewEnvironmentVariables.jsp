...
<%-- CONTENT--%>
  ...
  <div class="contents">
    <div class="system-helpbox">${ub:i18n("AgentEnvironmentVariableSystemHelpBox")}</div>

    <%@include file="environmentTable.inc"%>

    <c:if test="${inEditMode}">
        <%@include file="editEnvironmentVariableForm.inc"%>
    </c:if>
