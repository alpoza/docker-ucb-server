...
<div style="padding-bottom: 3em;">
  <div class="popup_header">
    <ul>
      <li class="current"><a>${ub:i18n("ProjectTemplateUsage")}</a></li>
    </ul>
  </div>
  ...
  <div class="contents">
    ...
    <div style="font-size: 16px; margin: 10px 5px;">${ub:i18nMessage("UsageFor", fn:escapeXml(projectTemplate.name))}</div>

    <div id="tableHolder" class="claro">
      <c:url var="projectTaskUrl" value="/tasks/project/ProjectTasks" />
      <div id="templateUsage" style="width: 100%; height: 700px"></div>
      <script type="text/javascript">
          require(["ubuild/module/UBuildApp", "ubuild/table/ProjectTemplateUsageTable"], function(UBuildApp, ProjectTemplateUsageTable) {
              UBuildApp.util.i18nLoaded.then(function() {
                  var table = new ProjectTemplateUsageTable({ "tasksUrl": "${projectTaskUrl}", "templateId": "${projectTemplate.id}"});
