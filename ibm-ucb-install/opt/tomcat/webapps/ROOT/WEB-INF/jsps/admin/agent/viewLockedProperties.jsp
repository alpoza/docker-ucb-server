...
<%-- TABS --%>
  ...
  <jsp:include page="/WEB-INF/jsps/admin/agent/agentTabs.jsp">
     <jsp:param name="selected" value="LockedProperties"/>
     <jsp:param name="disabled" value="${inEditMode}"/>
  </jsp:include>
...
<%-- CONTENT--%>
  ...
  <div class="contents">
    <div class="system-helpbox">${ub:i18n("AgentLockedPropertiesSystemHelpBox")}</div>
    <br/>
    <%@include file="lockedPropertyTable.inc"%>
