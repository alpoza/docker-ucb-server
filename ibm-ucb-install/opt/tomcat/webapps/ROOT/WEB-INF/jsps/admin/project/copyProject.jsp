...
<c:url var="saveUrl" value="${ProjectTasks.saveCopiedProject}"/>
<c:url var="cancelUrl" value="${ProjectTasks.cancelCopyProject}"/>
...
<form method="post" action="${fn:escapeXml(saveUrl)}">
  <div>
    <div class="popup_header">
      <ul>
        <li class="current"><a>${ub:i18n("CopyProject")}</a></li>
      </ul>
    </div>
    <div class="contents">
      ...
      <table class="property-table">
        <tbody>
          ...
          <c:set var="name" value="${ub:i18nMessage('CopyNoun', project.name)}"/>
          ...
          <tr class="${fn:escapeXml(eo.last)}" valign="top">
            ...
            <td align="left">
              <span class="inlinehelp">${ub:i18n("CopyProjectNameDesc")}</span>
            </td>
          </tr>
