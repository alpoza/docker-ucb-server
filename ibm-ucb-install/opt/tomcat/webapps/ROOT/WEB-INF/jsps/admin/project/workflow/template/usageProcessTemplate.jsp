...
<div style="padding-bottom: 3em;">
  <div class="popup_header">
    <ul>
      <li class="current"><a>${ub:i18n("WorkflowTemplateUsage")}</a></li>
    </ul>
  </div>
  ...
  <div class="contents">
    ...
    <div style="font-size: 16px; margin: 10px 5px;">${ub:i18nMessage("UsageFor", fn:escapeXml(workflowTemplate.name))}</div>

    <div id="tableHolder" class="claro">
      <c:url var="workflowTasksUrl" value="/tasks/project/WorkflowTasks" />
      <div id="templateUsage" style="width: 100%; height: 700px"></div>
      <script type="text/javascript">
          require(["ubuild/module/UBuildApp", "ubuild/table/ProcessTemplateUsageTable"], function(UBuildApp, ProcessTemplateUsageTable) {
              UBuildApp.util.i18nLoaded.then(function() {
                  var table = new ProcessTemplateUsageTable({ "tasksUrl": "${workflowTasksUrl}", "templateId": "${workflowTemplate.id}"});
