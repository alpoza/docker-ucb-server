...
<c:url var="formUrl" value="${ChangeSetTasks.viewWorkflowChangeSetsByUsers}"/>
...
<div class="contents">
  <form id="changeSetsForm" action="${fn:escapeXml(formUrl)}" method="get">
    <input type="hidden" id="workflowId" name="workflowId" value="${fn:escapeXml(workflow.id)}"/>  
    <c:import url="/WEB-INF/jsps/changeset/changesByUsers.jsp" />
  </form>
</div>
