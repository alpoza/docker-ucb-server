...
function(
     ...
     *  tasksUrl / String                   The URL for the ProjectTasks class. Required.
    ...
    return declare('js.ubuild.widgets.table.TemplateUsageTable', [_Widget, _TemplatedMixin], {
        ...
        postCreate: function() {
            ...
            var gridRestUrl = bootstrap.restUrl + "/templates/" + self.templateId + "/projects";
            ...
            this.grid = new Table({
                "url": gridRestUrl,
                "orderField": "name",
                "noDataMessage": i18n("ProjectNotFound"),
        ...
        viewProject: function(target) {
            var self = this;
            window.top.location = self.tasksUrl + "/viewDashboard?projectId=" + target.id;
        },
