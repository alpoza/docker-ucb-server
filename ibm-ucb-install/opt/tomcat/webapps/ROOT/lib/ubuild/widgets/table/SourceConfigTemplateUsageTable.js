...
function(
    ...
    return declare('js.ubuild.widgets.table.TemplateUsageTable', [_Widget, _TemplatedMixin], {
        ...
        postCreate: function() {
            ...
            var gridRestUrl = bootstrap.restUrl + "/sourceTemplates/" + self.templateId + "/sourceConfigs";

            var gridLayout = [{
                    name: i18n("SourceConfig"),
                    orderField: "name",
                    field: "name",
            ...
            this.grid = new Table({
                "url": gridRestUrl,
                "orderField": "name",
                "noDataMessage": i18n("SourceConfigsNotFound"),
        ...
        viewSourceConfig: function(target) {
            var self = this;
            window.top.location = self.tasksUrl + "/viewWorkflow?workflowId=" + target.processId;
        },
