...
function(
    ...
    /**
     * A build life source analytic summaries table widget with pagination, sorting, and custom formatting.
     ...
     *  url / String                   The URL to the report's summaries. Required.
     */
    
    return declare('js.ubuild.widgets.table.SourceAnalyticSummariesTable', [_Widget, _TemplatedMixin], {
        templateString: 
            '<div class="sourceAnalyticSummaryTable">'+
                '<div data-dojo-attach-point="sourceAnalyticSummariesGrid"></div>'+
            '</div>',
        displayId: false,
        displayStatus: false,
        ...
        postCreate: function() {
            ...
            this.grid.placeAt(this.sourceAnalyticSummariesGrid);
        },
